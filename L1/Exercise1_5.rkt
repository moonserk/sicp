...
;При аплиактивном порядке вычислений программа бесконечно будет выполнять вычисление, выполняя
;вычисление (y) в функции (test).
;При нормалном порядке вычислений программа даст резульат 0. 